...
from app.services.draft_notifications import draft_summary, notify_users_of_new_drafts
...
def scan_and_generate() -> int:
    ...
    with SessionLocal() as db:
        ...
        for template in templates:
            ...
            if existing is None:
                new_drafts.append(draft_summary(db, invoice, key))
            generated += 1
        db.commit()
        notify_users_of_new_drafts(db, new_drafts)
    return generated
